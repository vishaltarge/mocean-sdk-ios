//
//  MedialetsViewController.m
//  AdMobileSamples
//
//  Created by Constantine Mureev on 4/4/11.
//

#import "MedialetsViewController.h"


@implementation MedialetsViewController
...
- (void)viewDidLoad
{
	...
	_adView = [[AdView alloc] initWithFrame:CGRectMake(0, 0, 320, 50) site:8061 zone:16686];
	_adView.updateTimeInterval = 10;
	_adView.autoShowMode = YES;
