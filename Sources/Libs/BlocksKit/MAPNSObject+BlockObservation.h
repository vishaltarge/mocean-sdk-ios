//
//  MAPNSObject+BlockObservation.h
//
...
@interface NSObject (MAPBlockObservation)
...
/** Adds an observer to an object conforming to NSKeyValueObserving.
 ...
 observation with removeObserverWithBlockToken:.
 */
- (void)addObserverForKeyPath:(NSString *)keyPath identifier:(NSString *)token task:(MAPBlocksObservationBlock)task;
...
/** Adds an observer to an object conforming to NSKeyValueObserving.
 ...
 observation with removeObserverWithBlockToken:.
 */
- (void)addObserverForKeyPath:(NSString *)keyPath identifier:(NSString *)token options:(NSKeyValueObservingOptions)options task:(MAPBlocksObservationBlock)task;
