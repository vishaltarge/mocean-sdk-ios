...
#define kErrorMsgMustOverrideMethod @"You must override method - %@"
...
// The log level set to the adView will also be set to adapters, if the
// particular SDK supports log levels.
//
typedef enum {
    MASTAdapterLogNone = -1,
    MASTAdapterLogDebug,
    MASTAdapterLogInfo,
    MASTAdapterLogWarn,
    MASTAdapterLogError
...
@property(nonatomic,strong) NSDictionary *adapterDictionary;
@property(nonatomic,strong) MASTNativeAdAttributes *adAttributes;
...
/*!
 ...
 @abstract
 This is a method to associate a MASTNativeAd with the UIView you will use to display the native ads.
 
 @param view The UIView you created to render all the native ads data elements.
 @param viewController The UIViewController that will be used to present InApp Browser
